...
The Cellmine UI has been tested using Browserstack. [Check out their amazing software!](https://www.browserstack.com/)

![browserstack](src/markdown/figures/browserstack.png)
